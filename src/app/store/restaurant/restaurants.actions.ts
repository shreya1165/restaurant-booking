...
export const restaurantSucess = createAction(LOAD_RESTAURANT_SUCCESS,props<{list:Restaurants[]}>())
export const restaurantFail = createAction(LOAD_RESTAURANT_FAIL,props<{errorMessage:string}>())

export const bookRestaurantSlot = createAction(
    '[Booking] Book Restaurant Slot',
    props<{ id:number,date: Date, slot: string , numberOfPersons:string, option:string, restaurantName: string}>()
  );
